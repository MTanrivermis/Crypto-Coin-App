...
localStorage.setItem(
  "apiKey",
  EncryptStringAES(
    "coinranking254889bccdb8bff17fa6e0d89d489d31f7e29af752b833ae"
  )
);
...
const getCoinDataFromApi = async () => {
  ...
  //! önemli ***
  //? ${} yazım şekline teamplate literal denir.
  ...
  try {
    ...
    //console.log(iconUrl); // geliyor mu diye kontrol ediyoruz.
    ...
    //! append
    // coinList.append(createdLi); eklenen card yapısının sağına atar ama sonradan oluşan elementin ilk baş satıra gelmesi lazım
    //! prepend
    coinList.prepend(createdLi);
    //? silme tuşunu aktif ettik.
